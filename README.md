...
#### 📂 Настройка каналов
- **Канал увольнений** - настройка канала для рапортов на увольнение
- **Канал аудита** - настройка канала для кадрового аудита  
- **Канал чёрного списка** - настройка канала для чёрного списка
...
```json
{
    ...
    "ping_settings": {
        "123456789012345683": [123456789012345684, 123456789012345685],
        "123456789012345686": [123456789012345687]
    },
    "moderators": {
        "users": [123456789012345688, 123456789012345689],
        "roles": [123456789012345690]
    }
}
```
