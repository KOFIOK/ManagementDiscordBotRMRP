...
class AdminCommandsButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(
            ...
            value=(
                "`/message_request_edit`\n> - Редактирует сообщение *(file.md)* для электронных заявок\n"
...
class HelpSystem(commands.Cog):
    ...
    async def _process_help_command(self, interaction: discord.Interaction):
        ...
        try:
            ...
            logger.error("Ошибка при загрузке конфигурации в help_system: %s", e)
            is_mod = False
            is_admin = False
