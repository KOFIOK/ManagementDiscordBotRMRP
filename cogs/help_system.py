...
class ModeratorCommandsButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(
            ...
            value=(
                "~~`/повысить сотрудник:@user` **`необязательно:`***`звание:список-званий`* - Повысить пользователя в звании~~\n"
                "~~`/уволить сотрудник:@user причина:текст` - Уволить пользователя~~\n"
...
class PersonnelProcessesButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(
            ...
            value=(
                "• **Двухэтапная подача** - IC/OOC этапы с автопереходом\n"
                "• **Автозаполнение** - данные из Google Sheets\n"
                "• **Черновики** - сохранение незавершенных заявлений\n"
