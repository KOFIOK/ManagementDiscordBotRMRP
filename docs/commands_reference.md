...
- 🐦‍⬛ **Чёрный Пользователь** - Участник сервера, которому частично запрещено использовать функции бота
...
### Группа команд `/blacklist` 🐦‍⬛
**Управление чёрными пользователями**

#### `/blacklist add`
**Добавить чёрного пользователя**
- **Параметры:** 
  - `пользователь` - @упоминание пользователя
  - `роль` - @упоминание роли
- **Пример:** `/blacklist add @Петров#5678`

#### `/blacklist remove`
**Убрать чёрного пользователя**
- **Параметры:** аналогично `/blacklist add`
- **Пример:** `/blacklist remove @Петров#5678`

#### `/blacklist list`
**Список чёрного пользователя**
- **Показывает:** Всех пользователей и роли с правами модератора
- **Пример:** `/blacklist list`
