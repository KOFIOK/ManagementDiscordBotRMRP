...
class WarehouseManager:
        ...
        self.item_categories = {
            "🔫 Оружие": {
                ...
                "items": [
                    ...
                    "Штейр АУГ-А3", "Таурус Бешеный бык", "САР М249", "Другое оружие"
                ]
            },
            "🦺 Бронежилеты": {
                "emoji": "🦺", 
            ...
            "📦 Другое": {
                ...
                "key": "другое",
                "items": [
                    "Материалы", "Патроны", "Бодикамера", "Комплект Боец", "Прочее (указать вручную)"
                ]
            }
        }
    ...
    def validate_item_request(self, category_key: str, item_name: str, quantity: int, 
        ...
        if category_key == "оружие":
            ...
            if weapon_restrictions and item_name not in weapon_restrictions and item_name != "Другое оружие":
